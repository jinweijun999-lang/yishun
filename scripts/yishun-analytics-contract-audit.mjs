...
for (const reportNeedle of ["checkout_started", "entitlement_granted", "saved_report", "save_result", "save_click", "traffic_sources.csv", "traffic_campaigns.csv", "retention.csv", "eventValue"]) {
  ...
  JSON.stringify(
    {
      ...
      checks: [
        ...
        "daily_report_consumes_funnel_traffic_campaign_retention_saved_report_metrics",
      ],
    },
    null,
    2,
